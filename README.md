...
<b>Screenshot</b>
<ul>
  <li>gowitness-2.1.2-windows-amd64.exe scan cidr --cidr 192.168.230.0/24 --threads 10
...
<ul>
  ...
  <li> PingCastle.exe --server x.x.x.x --user domainuser --password domainpassword --export users
